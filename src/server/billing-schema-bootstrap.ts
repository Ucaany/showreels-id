...
CREATE TABLE IF NOT EXISTS "creator_settings" (
  ...
  "payment_method" text DEFAULT 'bayar_gg' NOT NULL,
...
CREATE TABLE IF NOT EXISTS "billing_transactions" (
  ...
  "provider" text DEFAULT 'bayar_gg' NOT NULL,
...
`));
  ...
  // Ensure generic payment columns exist for older billing tables.
  await db.execute(sql.raw(`
...
`));
  ...
  // Update default provider to Bayar.gg
  await db.execute(sql.raw(`
ALTER TABLE "billing_transactions"
