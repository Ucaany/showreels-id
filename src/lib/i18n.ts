...
export const dictionaries = {
  id: {
    ...
    landingThemesDescription:
      "Setiap tema disusun dari fitur inti showreels: custom links, social links, highlight video, dan kontak kolaborasi.",
    landingThemesCta: "Lihat semua tema",
    landingThemesPresetStarter: "Creator Starter",
    landingThemesPresetCampaign: "Campaign Focus",
    landingThemesPresetStudio: "Studio Portfolio",
    landingThemesPresetPersonal: "Personal Brand",
    landingThemesPresetAgency: "Team Showcase",
    landingThemesFeatureCustomLinks: "Custom links prioritas",
    landingThemesFeatureSocialLinks: "Social links terintegrasi",
    landingThemesFeatureVideoHighlight: "Highlight video unggulan",
    landingThemesFeatureContact: "Kontak & kolaborasi cepat",
    landingThemesFeatureVisibility: "Mode visibilitas profil",
    landingThemesFeaturePortfolio: "Katalog video rapi",
  ...
  en: {
    ...
    landingThemesDescription:
      "Each theme is generated from core showreels capabilities: custom links, social links, video highlights, and creator contact.",
    ...
    landingThemesPresetPersonal: "Personal Brand",
    landingThemesPresetAgency: "Team Showcase",
    landingThemesFeatureCustomLinks: "Priority custom links",
    landingThemesFeatureSocialLinks: "Integrated social links",
    landingThemesFeatureVideoHighlight: "Featured video highlight",
    landingThemesFeatureContact: "Fast contact & booking",
    landingThemesFeatureVisibility: "Profile visibility mode",
    landingThemesFeaturePortfolio: "Clean video catalog",
