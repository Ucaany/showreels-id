...
export const dictionaries = {
  id: {
    ...
    landingHeroDescription:
      "Bangun profil creator publik dengan avatar, cover, skills, dan daftar video portfolio. Bagikan satu link agar klien mudah menilai karya.",
    ...
    landingThemesFeatureCustomLinks: "Urutan link utama rapi",
    landingThemesFeatureSocialLinks: "Social & contact links jelas",
    landingThemesFeatureVideoHighlight: "Highlight video terbaru",
    landingThemesFeatureContact: "Header profil yang fokus",
  ...
  en: {
    ...
    landingHeroDescription:
      "Build a public creator profile with avatar, cover, skills, and your portfolio videos. Share one link so clients can review your work quickly.",
    ...
    landingThemesPresetPersonal: "Editorial Soft",
    landingThemesPresetAgency: "Minimal Contrast",
    landingThemesFeatureCustomLinks: "Clear priority links",
    landingThemesFeatureSocialLinks: "Readable social/contact links",
    landingThemesFeatureVideoHighlight: "Latest video highlight",
    landingThemesFeatureContact: "Focused profile header",
