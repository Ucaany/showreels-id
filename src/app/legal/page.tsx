        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          {legalLinks.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="group rounded-[1.25rem] border border-slate-200 bg-slate-50 px-4 py-4 transition hover:-translate-y-0.5 hover:border-[#fed7aa] hover:bg-[#fff7ed] hover:shadow-md hover:shadow-[#ea580c]/10 sm:px-5"
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="mt-1 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-[#ea580c] ring-1 ring-[#fed7aa] transition group-hover:bg-[#ea580c] group-hover:text-white">
