...
const sourcePool = [
  {
    ...
    previewImage: "https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
  ...
  },
  {
    ...
    previewImage: "https://vumbnail.com/76979871.jpg",
    previewType: "vimeo" as const,
    mediaType: "video" as const,
    aspectRatio: "landscape" as const,
  },
  {
    ...
    previewImage: "https://picsum.photos/seed/ig-reel/1280/720",
    previewType: "instagram" as const,
    mediaType: "video" as const,
  ...
  },
  {
    ...
    previewImage: "https://picsum.photos/seed/fb-video/1280/720",
    previewType: "facebook" as const,
    mediaType: "video" as const,
    aspectRatio: "landscape" as const,
  },
  {
    ...
    previewImage: "https://picsum.photos/seed/gdrive-video/1280/720",
    previewType: "gdrive" as const,
    mediaType: "video" as const,
    aspectRatio: "landscape" as const,
  },
];
...
function buildVideosForCreator(userId: string, username: string, index: number) {
  ...
  return [
    ...
    },
    {
      ...
      previewImage: second.previewImage,
      previewType: second.previewType,
    ...
    },
    {
      ...
      previewImage: third.previewImage,
      previewType: third.previewType,
    ...
    },
    {
      ...
      previewImage: fourth.previewImage,
      previewType: fourth.previewType,
      mediaType: fourth.mediaType,
      outputType: "Reels",
      durationLabel: "00:45",
