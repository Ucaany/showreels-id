...
const latestChange = {
	badge: "UPDATE",
	title: "Portfolio analytics baru",
	description: "Lihat traffic & views real-time.", // TIP: Use a single line of text for the description. (max 5 words)
	readMore: { href: "/dashboard/analytics", label: "Lihat Analytics" },
} as const;
