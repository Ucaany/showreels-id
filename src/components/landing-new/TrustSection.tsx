...
import { trustEN } from "@/lib/constants/landing-en";
...
export default function TrustSection() {
  ...
  return (
    <section className="relative -mt-2 bg-white pb-10 pt-2 md:-mt-4 md:pb-14 md:pt-3">
      <div className="container mx-auto flex max-w-[1180px] items-center justify-center px-6">
        <p className="inline-flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 font-sans text-[11px] font-medium text-ink/55 md:text-[12px]">
          <span className="inline-flex items-center gap-1.5">
            ...
            {isEN ? trustEN.encrypted : "Pembayaran terenkripsi & aman"}
          </span>
          ...
          <span className="inline-flex items-center gap-1.5">
            <RotateCcw
              ...
              strokeWidth={2.4}
            />
            {isEN ? trustEN.cancelAnytime : "Batalkan kapan saja"}
          </span>
        </p>
      </div>
    </section>
