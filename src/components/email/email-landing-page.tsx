      ...
      <div className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-2xl">
          ...
          >
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-[#1a46c9] to-[#4169e1] px-8 py-12 text-white">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-[#1a46c9]" />
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm transition focus:border-[#1a46c9] focus:outline-none focus:ring-2 focus:ring-[#dbe5ff]"
                  />
                </div>
                ...
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-[#1a46c9] text-white shadow-lg shadow-[#1a46c9]/30 hover:bg-[#153aa8]"
                >
                  {isSubmitting ? (
                    "Mengirim..."
                  ) : (
