  ...
  return (
    <div className="absolute bottom-5 left-5 z-20 hidden w-[min(18rem,calc(100%-2.5rem))] lg:block xl:bottom-6 xl:left-6">
      <div className="overflow-hidden rounded-[1.15rem] border border-white/14 bg-white/[0.08] p-3 text-white shadow-xl shadow-black/20 ring-1 ring-white/10 backdrop-blur-2xl">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(234,88,12,0.24),transparent_32%)]" />
        <div className="relative">
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#fed7aa]/25 bg-[#ea580c]/16 text-[#fed7aa] shadow-sm shadow-[#ea580c]/15">
                {feature.icon}
              </div>
                ...
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    index === currentFeature
                      ? "w-5 bg-[#ea580c] shadow-[0_0_12px_rgba(234,88,12,0.55)]"
