...
2. Fill these values:
   ...
   - `BAYAR_GG_DEFAULT_PAYMENT_METHOD` (default: `qris`)
...
## Billing (Bayar.gg Checkout)

- Billing upgrade now uses Bayar.gg hosted checkout (`/api/create-payment.php`) untuk pembayaran QRIS.
- Payment page route: `/payment?plan=creator|business`.
- Webhook endpoint: `/api/billing/bayar-gg/callback`.
- Required env:
  - `BAYAR_GG_API_KEY`
  - `BAYAR_GG_WEBHOOK_SECRET`
